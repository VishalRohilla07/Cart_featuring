...
class App extends React.Component {
  constructor() {
    ...
    this.state = {
      products: [
        ...
        },
        {
          ...
          title: "Phone",
          qty: 10,
          img: "https://images.unsplash.com/photo-1580910051074-3eb694886505?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8cGhvbmV8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=60",
          id: 2,
        },
        {
          price: 9999,
    ...
    //we can also use this method to bind
  ...
  handleDeleteProduct = (id) => {
    ...
    const items = products.filter((item) => item.id !== id); // will return an array [{}]
    this.setState({
      products: items,
    });
  };
